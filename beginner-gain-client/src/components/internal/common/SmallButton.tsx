...
const SmallButton = ({ title, color, isFilled, onClick, isDisabled }: IButton) => {
  if (color === "white") {
    return (
      <>
        <button
          className={
          `border border-purple-100 rounded-full min-w-24 text-xs duration-300 disabled:bg-purple-100/20
  ...
  return (
    <>
      <button
        className={
        `border border-black rounded-full min-w-24 text-xs duration-300 disabled:bg-purple-100/20
